...
## Input CSV Columns
`sourceId,title,sourceUrl,rawExcerpt,sourceName,_updatedAt,rewriteTitle,rewriteExcerpt,rewriteBody,coverArtConcept,coverArtPrompt,approval`
